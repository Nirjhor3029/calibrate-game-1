                        ...
                        <div class="input_field row">
                            <div class="col-md-7">
                                <div class="handle-counter" id="bd_A_pc_handleCounter">
                                    ...
                                    <button class="counter-plus btn" onclick="plus()">+</button>
                                </div>
                            </div>
                            <div class="col-md-5">
                                <p>Production cost</p>
                                ...
                                <div class="row ml-0 mr-0">
                                    ...
                                    <div class="col-9 col-sm-9 slidecontainer">
                                        <input type="range" min="1" max="100" value="0" class="slider"
                                            id="bd_pa_markup_range" wire:model="bn_a_markup">
                                    </div>
                                </div>
                        ...
                        <div class="row mb-10">
                            <div class="col-md-7">
                                <div class="row ml-0 mr-0">
                                    ...
                                    <div class="col-9 col-sm-9 slidecontainer">
                                        <input type="range" min="1" max="100" value="0" class="slider"
                                            id="bd_pb_markup_range" wire:model="bn_b_markup">
                                    </div>
                                </div>
                        ...
                        <div class="row mb-10">
                            <div class="col-md-7">
                                <div class="row ml-0 mr-0">
                                    ...
                                    <div class="col-9 col-sm-9 slidecontainer">
                                        <input type="range" min="1" max="100" value="0" class="slider"
                                            id="np_pa_markup_range" wire:model="np_a_markup">
                                    </div>
                                </div>
                                ...
                                <div class="row ml-0 mr-0">
                                    ...
                                    <div class="col-9 col-sm-9 slidecontainer">
                                        <input type="range" min="1" max="100" value="1" class="slider"
                                            id="np_pb_markup_range" wire:model="np_b_markup">
                                    </div>
                                </div>
