        ...
        <div class="details">
            ...
            <script>
                ...
                $("#cashFlow_sortable").sortable({
                    cursor: "move",
                    cursorAt: {left: 25},
                    connectWith: ["#cash_for_customer", "#cash_for_expense", "#cash_to_supplier", "#cash_for_interest", "#cash_for_tax"]
                });
                var expense = new Map();
                ...
                function sendCashFlowData(dataType, index_id, array_data, total) {
                    $(document).ready(function () {
                        ...
                        let data = {dataId: dataType, id: index_id, sendData: array_data, totalreview: total};
                        $.ajax({
                            type: "POST",
